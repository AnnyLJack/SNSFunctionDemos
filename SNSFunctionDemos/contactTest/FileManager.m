...
#define kPhotoCacheFolder   @"photoCachePath"
...
+ (NSString *)makePhotoCachePath:(NSString *)fileName {

    NSFileManager *fileManager = [[NSFileManager alloc] init];
    
    NSString *strPhoto = [FileManager getFilePathOfCache:kPhotoCacheFolder];
    ...
    NSString *strMD5 = [FileManager MD5:fileName];
    
    if (strMD5 && 0 < strMD5.length)
    {
        NSString *folderPath = [FileManager getFilePathOfCache:kPhotoCacheFolder];
