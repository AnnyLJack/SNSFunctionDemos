//
//  LargeImageTestViewController.m
//  SNSFunctionDemos
//
//  Created by SohuSns on 5/2/16.
...
@interface LargeImageTestViewController ()<UICollectionViewDataSource,UICollectionViewDelegate>

@property (nonatomic, copy)   NSArray<XMNAssetModel *> *assets;
@property (nonatomic, strong) UICollectionView *collectionView;
@end

@implementation LargeImageTestViewController
